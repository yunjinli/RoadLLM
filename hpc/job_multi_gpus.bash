if [ "$#" -ne 3 ]; then
    echo "Usage: $0 <num_gpus> <num_cpus> <llm>"
    exit 1
fi
...
command="WANDB_MODE=offline TRANSFORMERS_CACHE=/home/phd_li/.cache/huggingface/hub HF_HUB_OFFLINE=1 deepspeed --num_gpus ${NUM_GPUS} llava/train/train_mem.py \
